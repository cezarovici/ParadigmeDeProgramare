...
if __name__ == "__main__":
    ...
    leftBracket = Button(gui,text="(",fg='white', bg='blue',
                      command=lambda: press("("), height=1, width=7)
    leftBracket.grid(row=2,column=6)

    # paranteza inchis

    rightBracket = Button(gui,text=")",fg='white', bg='blue',
                      command=lambda: press(")"), height=1, width=7)
    rightBracket.grid(row=3,column=6)
